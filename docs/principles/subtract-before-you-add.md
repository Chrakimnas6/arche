...
In smart contracts, subtraction is even more valuable -- every line of deployed code is attack surface. Remove unused functions, dead modifiers, and speculative extension points before shipping. Gas cost is proportional to complexity; less code means cheaper execution.
